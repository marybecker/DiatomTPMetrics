...
spp <- read.csv ("data/SPP.csv",header=TRUE,row.names=1,sep=",")
TP <- read.csv ("data/TP.csv",header=TRUE,row.names=1,sep=",")
...
TPsamp <- sample(nrow(SPP.TP1),size=225)
...
write.table(ROCCnt,"ROC_SppGAM.csv",sep=",",row.names=TRUE,col.names=NA)
write.table(IncrCnt,"Inc_SppGAM.csv",sep=",",row.names=TRUE,col.names=NA)
write.table(DecrCnt,"Dec_SppGAM.csv",sep=",",row.names=TRUE,col.names=NA)
write.table(UniCnt,"Uni_SppGAM.csv",sep=",",row.names=TRUE,col.names=NA)
